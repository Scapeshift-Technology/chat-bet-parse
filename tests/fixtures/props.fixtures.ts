...
export const propsOUTestCases: TestCase[] = [
  ...
  {
    description: 'YG NBA player PRA under with lowercase pts+reb+ast',
    input: 'YG NBA Kawhi Leonard u33.5 pts+reb+ast @ -115 = 4k',
    expectedChatType: 'fill',
    expectedContractType: 'PropOU',
    expectedPrice: -115,
    expectedSize: 4000,
    expectedPlayer: 'Kawhi Leonard',
    expectedPlayerTeam: undefined,
    expectedTeam1: undefined,
    expectedLine: 33.5,
    expectedIsOver: false,
  ...
  {
    description: 'YG NBA player PRA over with titlecase Pts+Rebs+Asts',
    input: 'YG NBA Devin Booker Pts+Rebs+Asts o41.5 @ +105 = 2.8k',
    expectedChatType: 'fill',
    expectedContractType: 'PropOU',
    expectedPrice: 105,
    expectedSize: 2800,
    expectedPlayer: 'Devin Booker',
    expectedPlayerTeam: undefined,
    expectedTeam1: undefined,
    expectedLine: 41.5,
    expectedIsOver: true,
  ...
  {
    description: 'YG NBA player 3pt Shots Made under',
    input: 'YG NBA Ryan Rollins 3pt Shots Made u1.5 @ +105 = 1k',
    expectedChatType: 'fill',
    expectedContractType: 'PropOU',
    expectedPrice: 105,
    expectedSize: 1000,
    expectedPlayer: 'Ryan Rollins',
    expectedPlayerTeam: undefined,
    expectedTeam1: undefined,
    expectedLine: 1.5,
    expectedIsOver: false,
    expectedProp: 'ThreePointersMade',
    expectedContestantType: 'Individual',
    expectedSport: 'Basketball',
    expectedLeague: 'NBA',
    expectedPeriod: { PeriodTypeCode: 'M', PeriodNumber: 0 }
  ...
  {
    description: 'YG NBA player 3pt Shots Made over',
    input: 'YG NBA Donte DiVincenzo 3pt Shots Made o3.5 @ +125 = 2.8k',
    expectedChatType: 'fill',
    expectedContractType: 'PropOU',
    expectedPrice: 125,
    expectedSize: 2800,
    expectedPlayer: 'Donte DiVincenzo',
    expectedPlayerTeam: undefined,
    expectedTeam1: undefined,
    expectedLine: 3.5,
    expectedIsOver: true,

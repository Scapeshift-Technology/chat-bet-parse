...
testSuite('Grading Integration Tests', () => {
  ...
  describe('Grading Functionality', () => {
    ...
    describe('TotalPoints Contracts', () => {
      ...
      it('should grade total push', async () => {
        ...
        const grade = await client.grade(parseResult, { matchScheduledDate: new Date('2025-05-31') });
    ...
    describe('PropOU Contracts', () => {
      it.skip('should grade player prop over - Auto-grading not tested yet', async () => {
        ...
        const grade = await client.grade(parseResult, { 
      ...
      it.skip('should grade team rebounds over - Auto-grading not tested yet', async () => {
        ...
        const grade = await client.grade(parseResult, { matchScheduledDate: new Date('2025-04-30') });
        expect(['L']).toContain(grade);
      });
    ...
    describe('Series Contracts', () => {
      ...
      it.skip('should grade 3-match series - Auto-grading not tested yet', async () => {
        ...
        const grade = await client.grade(parseResult, { matchScheduledDate: new Date('2025-05-22') });
        expect(['W']).toContain(grade);
      });
  ...
  describe('Error Handling', () => {
    ...
    describe('Data Validation Errors', () => {
      ...
      it('should handle contracts with missing required data', async () => {
        ...
        await expect(client.grade(parseResult)).rejects.toThrow(GradingDataError);
      });
    });
  });
  ...
  describe('Performance and Resource Management', () => {
    it('should handle multiple rapid grade calls', async () => {
      ...
      const promises = Array(5).fill(null).map(() => 
        client.grade(parseResult, { matchScheduledDate: new Date('2025-06-01') })
      );
    ...
    it('should maintain connection state across multiple operations', async () => {
      ...
      // Multiple operations
      const grade1 = await client.grade(parseResult, { matchScheduledDate: new Date('2025-05-31') });
      const grade2 = await client.grade(parseResult, { matchScheduledDate: new Date('2025-06-01') });
  ...
  describe('Edge Cases', () => {
    ...
    it('should handle contracts with game numbers', async () => {
      ...
      const grade = await client.grade(parseResult, { matchScheduledDate: new Date('2025-05-14') });
      expect(['L']).toContain(grade);
      ...
      const grade2 = await client.grade(parseResult2, { matchScheduledDate: new Date('2025-05-14') });
    ...
    it('should handle different date scenarios', async () => {
      ...
      const grade1 = await client.grade(parseResult, { matchScheduledDate: new Date('2025-04-22') });
      const grade2 = await client.grade(parseResult, { matchScheduledDate: new Date('2025-04-27') });
